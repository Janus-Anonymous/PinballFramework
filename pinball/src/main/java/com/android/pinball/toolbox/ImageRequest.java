...
import com.android.pinball.DefaultRetryPolicy;
import com.android.pinball.NetworkResponse;
import com.android.pinball.ParseError;
    ...
    protected Response<Bitmap> parseNetworkResponse(NetworkResponse response) {
        ...
        synchronized (sDecodeLock) {
            try {
                ...
                PinballLog.e("Caught OOM for %d byte image, url=%s", response.data.length, getUrl());
