...
import com.android.pinball.PinballLog.MarkerLog;
...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     *
     * @param PinballError the error retrieved from the network
     * @return an NetworkError augmented with additional information
     */
    protected PinballError parseNetworkError(PinballError PinballError) {
        return PinballError;
    }
     ...
     */
    public void deliverError(PinballError error) {
