...
public class Response<T> {
     ...
     */
    public final PinballError error;
    /**
    ...
    private Response(PinballError error) {
        this.result = null;
     ...
     */
    public static <T> Response<T> error(PinballError error) {
    ...
    public interface ErrorListener {
         ...
         */
        void onErrorResponse(PinballError error);
    }
