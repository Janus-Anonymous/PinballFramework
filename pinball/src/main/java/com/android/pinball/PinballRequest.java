...
public class PinballRequest extends Request<byte[]> {
     ...
     * @param tag
     */
    public PinballRequest(String url, int property, int delay, String tag) {
     ...
     * @param tag
     */
    public PinballRequest(String url, int property, String tag) {
